  ...
  describe "EVM" do
    ...
    describe 'Ease of Movement' do
      it 'Calculates EVM (14 day)' do
        output = TechnicalAnalysis::Evm.calculate(input_data, period: 14)
      ...
      it "Throws exception if not enough data" do
        expect {TechnicalAnalysis::Evm.calculate(input_data, period: input_data.size+2)}.to raise_exception(Validation::ValidationError)
      end
    end
  end
end
